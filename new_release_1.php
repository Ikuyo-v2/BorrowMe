 ...
 <header>
  ...
  <section class="categories">
      ...
      <div class="category-list">
        <p><a href="new_release_1.php" class="<?php echo (!$selected_category) ? 'active-category' : ''; ?>">All Categories</a></p>
        <?php foreach ($categories as $category_name): ?>
          <p>
            <a href="new_release_1.php?category=<?php echo ($category_name); ?>" 
